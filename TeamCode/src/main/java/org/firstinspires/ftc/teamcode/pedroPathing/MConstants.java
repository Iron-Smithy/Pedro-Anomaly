...
public class MConstants {
    ...
    public static final com.pedropathing.control.PIDFCoefficients turretPIDFCoefficent =
            new com.pedropathing.control.PIDFCoefficients(0.006, 0.0006, 0.0004, 0.0007); // turret overshoot, keep increasing D until it disappears
    // original PIDF (0.006, 0, 0.0004, 0.0007)  (0.004, 0, 0.0003, 0.0007); 0.0006              // if clicking appears in the motor again, lower P by 10-20% then re-adjust D
