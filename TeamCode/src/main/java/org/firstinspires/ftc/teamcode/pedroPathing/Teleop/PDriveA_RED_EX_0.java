...
import static org.firstinspires.ftc.teamcode.pedroPathing.Teleop.PDriveA_BLUE_EX_0.TURN_P;
...
public class PDriveA_RED_EX_0 extends OpMode {
    ...
    // experimetnal ====================================================================================================================================================================================
    public static final Pose GOAL_POSE = new Pose(132, 136, 0);
    ...
    public void init() {
        ...
        // Point 4: Far shot
        speedMap.put(12.0 * 14, 1550L); // TUNE ME!!!
    }
...
//                outtakeSpeed = getInterpolatedSpeed(distToGoal);
    ...
    /**
     * Standard Angle Wrap (keeps angle error between -PI and PI)
     */
