...
// */
//@Autonomous(name = "secondTryR", group = "AAA")
//public class SecondAutoR extends OpMode {
//
//    // ========================= Hardware =========================
...
//    private final Pose scorePose = new Pose(84, 84, Math.toRadians(220));
//    private final Pose tR1 = new Pose(90, 80,Math.toRadians(0));
//    private final Pose R1 = new Pose(110, 80, Math.toRadians(0));
//
...
//
//            case SCORE_PRELOAD:
//                actions.spinUpShooter(2170, 1.0);
//                actions.intakeOn(-1);
//
//                if (actions.shootAuto(2170, 1.0, 1500, 6000, pathTimer.getElapsedTime())) {
...
public class SecondAutoR extends OpMode {
    ...
    // ========================= Path Definitions =========================
    private final Pose startPose = new Pose(120, 120, Math.toRadians(215));
    private final Pose scorePose = new Pose(84, 84, Math.toRadians(222));
    private final Pose tR1 = new Pose(90, 80,Math.toRadians(0));
    private final Pose R1 = new Pose(120, 80, Math.toRadians(0));
    ...
    private void updateAutonomous() {
        switch (currentState) {
            ...
            case TURN_R1:
                ...
                if (actions.shootAuto(2120, 1.0, 1500, 6000, pathTimer.getElapsedTime()) || pathTimer.getElapsedTime() >= 10000) {
                    actions.stopIndex();
                    follower.followPath(eatR1);
                    transitionTo(AutoState.INTAKE_R1);
                }
