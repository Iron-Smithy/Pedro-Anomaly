...
@Autonomous(name = "Auton_BLUE_far_1", group = "AAA")
public class Auton_BLUE_far_1 extends OpMode {
    ...
    private final Pose startPose = new Pose(48, 9, Math.toRadians(90)); // start location
    private final Pose ScorePose = new Pose(54, 13, Math.toRadians(109)); // score location
    private final Pose R3PrePose = new Pose(45, 35.5, Math.toRadians(180)); // row 1 collection pre location
    private final Pose R3CollectPose = new Pose(20, 35.5, Math.toRadians(180)); // row 1 balls inside robot location
    private final Pose RHuman = new Pose(9, 9, Math.toRadians(180)); // smooth back-out bezier control point
