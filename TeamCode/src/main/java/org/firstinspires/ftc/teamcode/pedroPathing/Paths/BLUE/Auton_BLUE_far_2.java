...
@Autonomous(name = "Auton_BLUE_far", group = "AAA")
public class Auton_BLUE_far_2 extends OpMode {
    ...
    private final Pose startPose = new Pose(48, 8, Math.toRadians(90)); // start location
