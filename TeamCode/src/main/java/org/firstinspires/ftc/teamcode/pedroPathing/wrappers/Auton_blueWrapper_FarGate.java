...
// Simple wrapper for AutonB_FarGate_0 that sets the alliance to BLUE.
...
@Autonomous(name = "Auton Blue Far Gate", group = "AAA")
public class Auton_blueWrapper_FarGate extends AutonB_FarGate_0 {
    @Override
    public void init() {
