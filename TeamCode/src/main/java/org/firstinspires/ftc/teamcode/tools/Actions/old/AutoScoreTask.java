...
//
//    private final long feedDelay = 300;      // ms ejector stays up
//    private final long interShotDelay = 500; // ms between shots
//
//    public AutoScoreTask(Follower follower, OuttakeAction shooter, IndexAction indexer, EjectorAction ejector,
//                         Pose targetPose, double targetTPS) {
